...
class PumpDatabase {
  ...
  seed() {
    ...
    pumps.forEach((pump, idx) => {
      ...
      for (let i = 1; i <= unitCount; i++) {
        insertUnit.run(
          ...
          pump.head,
          pump.power / (unitCount - (i === unitCount ? 1 : 0)),
    ...
    const pipelineNodes = [
      { code: "N001", name: "城东泵站出口", type: "pump", longitude: 114.3256, latitude: 30.5678, connected: [2, 3], maxLevel: 5, warningLevel: 3.5 },
      ...
      { code: "N005", name: "城西泵站出口", type: "pump", longitude: 114.289, latitude: 30.5612, connected: [3, 7], maxLevel: 4.5, warningLevel: 3 },
      { code: "N006", name: "城北泵站出口", type: "pump", longitude: 114.3001, latitude: 30.5987, connected: [4, 8], maxLevel: 4, warningLevel: 2.7 },
      ...
      { code: "N009", name: "中心枢纽站出口", type: "pump", longitude: 114.3015, latitude: 30.565, connected: [7, 8, 10], maxLevel: 5.5, warningLevel: 3.8 },
...
function registerIpcHandlers() {
  ...
  electron.ipcMain.handle("monitoring:alerts", () => db.getActiveAlerts());
