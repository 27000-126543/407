...
electron.contextBridge.exposeInMainWorld("api", {
  ...
  schedule: {
    ...
    reject: (id, approver, reason) => electron.ipcRenderer.invoke("schedule:reject", id, approver, reason),
  ...
  monitoring: {
    ...
    insertAlert: (alert) => electron.ipcRenderer.invoke("monitoring:alert:insert", alert),
    ackAlert: (id, operator) => electron.ipcRenderer.invoke("monitoring:alert:ack", id, operator),
    disposalRecords: (alertId) => electron.ipcRenderer.invoke("monitoring:disposal:list", alertId),
    addDisposalRecord: (data) => electron.ipcRenderer.invoke("monitoring:disposal:add", data),
    updateDisposalRecord: (id, data) => electron.ipcRenderer.invoke("monitoring:disposal:update", id, data)
  },
  maintenance: {
